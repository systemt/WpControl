 ...
 * Description:       DigiForce central management agent: settings, admin UI, local logging, update scanning, HMAC-signed REST API, and remote plugin management commands.
 * Version:           1.2.0
...
define( 'DIGIFORCE_WPA_VERSION', '1.2.0' );
